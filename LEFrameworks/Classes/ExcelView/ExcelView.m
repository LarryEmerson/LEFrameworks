...
#import "ExcelView.h"
@interface ExcelViewTableViewCell ()
@property (nonatomic) ExcelViewTableView *curTableView;
@end
@implementation ExcelViewTableViewCell{
...
-(void) setCurTableView:(ExcelViewTableView *)curTableView{
...
@end
@implementation ExcelViewTabbar{
    ExcelViewTableView *curTableView;
}
...
-(void) addSwipObserver:(ExcelViewTableView *)tableView{
...
@end
@implementation ExcelViewTableView{
    int immovableWidth;
    int movableWidth;
    int curHeight;
    int tabbarHeight;
    NSString *curTabbarClassName;
    ExcelViewTabbar *curTabbar;
}
...
-(UITableViewCell *) _cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ExcelViewTableViewCell *cell=[self dequeueReusableCellWithIdentifier:CommonTableViewReuseableCellIdentifier];
    if(!cell){
...
-(id) initWithSettings:(LETableViewSettings *)settings ImmovableViewWidth:(int) immovable MovableViewWidth:(int) movable TabbarHeight:(int) tabbarH TabbarClassname:(NSString *) tabbar{
    ...
    curTableView=[[ExcelViewTableView alloc] initWithSettings:settings ImmovableViewWidth:immovable MovableViewWidth:movable TabbarHeight:tabbarH CellHeight:DefaultCellHeightBig TabbarClassname:tabbar];
