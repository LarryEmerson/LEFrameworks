...
#define LEIS_IPHONE_X [[NSString stringWithFormat:@"%.0f",floorf(LESCREEN_MAX_LENGTH *100.0/LESCREEN_MIN_LENGTH)] isEqualToString:@"216"]
...
#define LEColorSplit              [UIColor colorWithRed:0.9 green:0.9 blue:0.9 alpha:1.0]
